...
namespace TesteBack.Model.Validation
{
    public class Validacoes
    {
        ...
        public static void ValidarTamanho(string valor, int maximo, string mensagem)
        {
            ...
            if (length > maximo)
            {
                throw new DomainException(string.Format(mensagem, maximo));
            }
        }
        ...
        public static void ValidarSeVazio(DateTime valor, string mensagem)
        {
        ...
        public static void ValidarSeVazio(int valor, string mensagem)
        {
            if (valor == 0)
            {
                throw new DomainException(mensagem);
